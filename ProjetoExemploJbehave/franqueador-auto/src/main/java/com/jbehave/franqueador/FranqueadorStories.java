package com.jbehave.franqueador;
...
public class FranqueadorStories extends JUnitStories {
    ...
    StoryReporterBuilder reporterBuilder = new StoryReporterBuilder()
            .withCodeLocation(codeLocationFromClass(FranqueadorStories.class)).withFailureTrace(true)
    ...
    public Configuration configuration() {
        return new SeleniumConfiguration().useSeleniumContext(seleniumContext)
                ...
                .useStoryLoader(new LoadFromClasspath(FranqueadorStories.class))
                .useStoryReporterBuilder(reporterBuilder);
    }

    @Override
    public InjectableStepsFactory stepsFactory() {
        ApplicationContext context = new SpringApplicationContextFactory("franqueador-steps.xml").createApplicationContext();
    ...
    protected List<String> storyPaths() {
        return new StoryFinder().findPaths(codeLocationFromClass(this.getClass()).getFile(),
                asList("**/" + System.getProperty("storyFilter", "Login") + ".story"), null);
    }
